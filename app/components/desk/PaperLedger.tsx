  ...
  return (
    <form action={formAction} className="flex items-center gap-2">
      ...
      <input
        ...
        placeholder="exit"
        required
        className="w-20 rounded-edge border border-hairline bg-surface px-2 py-0.5 font-mono text-2xs text-ink"
      />
      <button
        type="submit"
        className="rounded-edge border border-hairline px-2 py-0.5 font-ui text-2xs uppercase tracking-[0.05em] text-ink hover:border-accent"
      >
        Close
      </button>
